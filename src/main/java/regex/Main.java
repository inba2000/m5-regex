...
public class Main {
    ...
    // TODO: Modify this code to check if the given string is non-empty, contains at
    // least
    ...
    public static boolean checkForPassword(String str, int minLength) {
        ...
        // .{minLength,} ensures total length is at least minLength
        String regex = "(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9]).{" + minLength + ",}";
        return Pattern.matches(regex, str);
    }

    // Method 2 for checking if a string conforms to a regex: using Matcher.find
    // TODO: Modify this method to return a list of all email addresses contained in
    // the
    ...
    public static List<String> extractEmails(String str) {
        ...
        // [A-Za-z0-9._%+-]+ matches the username part (at least one character)
        // @ matches the @ symbol
        // (mail\.)? matches optional "mail."
        // utoronto\.ca matches "utoronto.ca"
    ...
    // TODO: Modify this method to check whether or not the string contains the same
    // capital letter
    ...
    public static boolean checkForDoubles(String str) {
        ...
        // \1 matches the same captured capital letter
